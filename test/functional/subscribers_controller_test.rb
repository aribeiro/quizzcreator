...
class SubscribersControllerTest < ActionController::TestCase
  ...
  test "should show subscriber" do
    get :show, :id => subscribers(:one).to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, :id => subscribers(:one).to_param
    assert_response :success
  end

  test "should update subscriber" do
    put :update, :id => subscribers(:one).to_param, :subscriber => { }
    assert_redirected_to subscriber_path(assigns(:subscriber))
  end

  test "should destroy subscriber" do
    assert_difference('Subscriber.count', -1) do
      delete :destroy, :id => subscribers(:one).to_param
    end
